...
public static class Vibration
{
    ...
    ///<summary>
    /// Tiny pop vibration: weak boom (For iOS: only available with the haptic engine. iPhone 6s minimum or Android)
    ///</summary>
    ...
    ///<summary>
    /// Small peek vibration: strong boom (For iOS: only available on iOS with the haptic engine. iPhone 6s minimum or Android)
    ///</summary>
    ...
    ///<summary>
    /// 3 small vibrations: Nope vibration: series of three weak booms (For iOS: only available with the haptic engine. iPhone 6s minimum or Android)
    ///</summary>
